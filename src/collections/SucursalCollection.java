...
public class SucursalCollection {
	private ArrayList<SucursalDTO> datos;
	...
	public ArrayList<SucursalDTO> getSucursalList()
	{
		return datos;
	}
	
	public SucursalDTO getSucursal(int index)
	{
    ...
    private ArrayList<SucursalDTO> leer() {

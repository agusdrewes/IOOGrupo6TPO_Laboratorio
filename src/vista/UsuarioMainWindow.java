...
public class UsuarioMainWindow {
	...
	*/
	...
	private void eliminarUsuario() {
		try {
			int opcion = JOptionPane.showConfirmDialog(null, "Este seguro que desea eliminar a este Usuario?", null,
	...
	private void agregarUsuario() {
		try {
			...
			if (dialog.getModalResult() == ModalResult.OK)
				tableModel.agregar(dialog.getUsuario());
		} catch (Exception e) {
			e.printStackTrace();
		}				
	}
	...
	private void modificarUsuario() {
		try {
			...
			dialog.setVisible(true);
			if (dialog.getModalResult() == ModalResult.OK)
				tableModel.modificar(dialog.getUsuario());
		} catch (Exception e) {
			e.printStackTrace();
		}			
	}
	...
	private void initialize() {
		...
		btnEliminar.setIcon(new ImageIcon(UsuarioMainWindow.class.getResource("/res/iconoEliminar24px.png")));
		
		JButton btnModificar = new JButton("Modificar");
		btnModificar.setIcon(new ImageIcon(UsuarioMainWindow.class.getResource("/res/iconoModificar24px.png")));
		...
		btnAgregar.setIcon(new ImageIcon(UsuarioMainWindow.class.getResource("/res/iconoAgregar24px.png")));

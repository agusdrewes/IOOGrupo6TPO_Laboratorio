...
public class PacienteMainWindow {
	...
	private void agregarPaciente() {
		try {
			...
			if (dialog.getModalResult() == ModalResult.OK)
				tableModel.agregar(dialog.getPaciente());
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	private void modificarPaciente() {
		try {
			...
			dialog.setVisible(true);
			if (dialog.getModalResult() == ModalResult.OK)
				tableModel.modificar(dialog.getPaciente());
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	private void eliminarPaciente() {
		try {
			int opcion = JOptionPane.showConfirmDialog(null, "Esta seguro que desea eliminar a este Paciente?", null,
	...
	private void initialize() {
		...
		btnEliminar.setIcon(new ImageIcon(PacienteMainWindow.class.getResource("/res/iconoEliminar24px.png")));

		JButton btnModificar = new JButton("Modificar");
		btnModificar.setIcon(new ImageIcon(PacienteMainWindow.class.getResource("/res/iconoModificar24px.png")));
		...
		btnAgregar.setIcon(new ImageIcon(PacienteMainWindow.class.getResource("/res/iconoAgregar24px.png")));
